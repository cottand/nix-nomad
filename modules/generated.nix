...
{
  _module.types.Action =
    with lib;
    with config._module.types;
    with lib.types;
    submodule (
      { name, ... }:
      {
  ...
  _module.types.ConsulExposeConfig =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulExposePath =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulGatewayBindAddress =
    with lib;
    with config._module.types;
    with lib.types;
    submodule (
  ...
  _module.types.ConsulGatewayProxy =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulGatewayTlsConfig =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulGatewayTlssdsConfig =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulHttpHeaderModifiers =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulIngressConfigEntry =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulIngressListener =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulIngressService =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulLinkedService =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulMeshConfigEntry =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
    });
  _module.types.ConsulMeshGateway =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulSidecarService =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulTerminatingConfigEntry =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ConsulTransparentProxy =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.DisconnectStrategy =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.DispatchPayloadConfig =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.MultiregionRegion =
    with lib;
    with config._module.types;
    with lib.types;
    submodule (
  ...
  _module.types.MultiregionStrategy =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ParameterizedJobConfig =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.ReschedulePolicy =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.TaskCsiPluginConfig =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.TaskScheduleCron =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.types.WorkloadIdentity =
    with lib;
    with config._module.types;
    with lib.types;
    submodule ({
  ...
  _module.transformers.Action.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
  ...
  _module.transformers.Action.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Affinity.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.Affinity.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.CniConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.CniConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs: ({ } // (if attrs ? Args && attrs.Args != null then { args = attrs.Args; } else { }));

  # Convert a CsiMountOptions Nix module into a JSON object.
  _module.transformers.CsiMountOptions.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.CsiMountOptions.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ChangeScript.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? command && attrs.command != null then { Command = attrs.command; } else { })
        // (
          if attrs ? failOnError && attrs.failOnError != null then
            { FailOnError = attrs.failOnError; }
          else
            { }
        )
  ...
  _module.transformers.ChangeScript.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.CheckRestart.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? ignoreWarnings && attrs.ignoreWarnings != null then
            { IgnoreWarnings = attrs.ignoreWarnings; }
          else
            { }
        )
  ...
  _module.transformers.CheckRestart.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Constraint.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.Constraint.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Consul.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.Consul.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulConnect.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? gateway && attrs.gateway != null then
            { Gateway = ConsulGateway.toJSON attrs.gateway; }
          else
            { }
        )
        // (if attrs ? native && attrs.native != null then { Native = attrs.native; } else { })
        // (
          if attrs ? sidecarService && attrs.sidecarService != null then
            { SidecarService = ConsulSidecarService.toJSON attrs.sidecarService; }
          else
            { }
        )
        // (
          if attrs ? sidecarTask && attrs.sidecarTask != null then
            { SidecarTask = SidecarTask.toJSON attrs.sidecarTask; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulConnect.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Gateway && attrs.Gateway != null then
          { gateway = ConsulGateway.fromJSON attrs.Gateway; }
        else
          { }
      )
      // (if attrs ? Native && attrs.Native != null then { native = attrs.Native; } else { })
      // (
        if attrs ? SidecarService && attrs.SidecarService != null then
          { sidecarService = ConsulSidecarService.fromJSON attrs.SidecarService; }
        else
          { }
      )
      // (
        if attrs ? SidecarTask && attrs.SidecarTask != null then
          { sidecarTask = SidecarTask.fromJSON attrs.SidecarTask; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulExposeConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? paths && builtins.isList attrs.paths then
            { Paths = builtins.map ConsulExposePath.toJSON attrs.paths; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulExposeConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Paths && builtins.isList attrs.Paths then
          { paths = builtins.map ConsulExposePath.fromJSON attrs.Paths; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulExposePath.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? listenerPort && attrs.listenerPort != null then
            { ListenerPort = attrs.listenerPort; }
          else
            { }
        )
        // (
          if attrs ? localPathPort && attrs.localPathPort != null then
            { LocalPathPort = attrs.localPathPort; }
          else
            { }
        )
  ...
  _module.transformers.ConsulExposePath.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulGateway.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? ingress && attrs.ingress != null then
            { Ingress = ConsulIngressConfigEntry.toJSON attrs.ingress; }
          else
            { }
        )
        // (
          if attrs ? mesh && attrs.mesh != null then
            { Mesh = ConsulMeshConfigEntry.toJSON attrs.mesh; }
          else
            { }
        )
        // (
          if attrs ? proxy && attrs.proxy != null then
            { Proxy = ConsulGatewayProxy.toJSON attrs.proxy; }
          else
            { }
        )
        // (
          if attrs ? terminating && attrs.terminating != null then
            { Terminating = ConsulTerminatingConfigEntry.toJSON attrs.terminating; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulGateway.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Ingress && attrs.Ingress != null then
          { ingress = ConsulIngressConfigEntry.fromJSON attrs.Ingress; }
        else
          { }
      )
      // (
        if attrs ? Mesh && attrs.Mesh != null then
          { mesh = ConsulMeshConfigEntry.fromJSON attrs.Mesh; }
        else
          { }
      )
      // (
        if attrs ? Proxy && attrs.Proxy != null then
          { proxy = ConsulGatewayProxy.fromJSON attrs.Proxy; }
        else
          { }
      )
      // (
        if attrs ? Terminating && attrs.Terminating != null then
          { terminating = ConsulTerminatingConfigEntry.fromJSON attrs.Terminating; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulGatewayBindAddress.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.ConsulGatewayBindAddress.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulGatewayProxy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? connectTimeout && attrs.connectTimeout != null then
            { ConnectTimeout = attrs.connectTimeout; }
          else
            { }
        )
        // (
          if attrs ? envoyDnsDiscoveryType && attrs.envoyDnsDiscoveryType != null then
            { EnvoyDNSDiscoveryType = attrs.envoyDnsDiscoveryType; }
          else
            { }
        )
        // (
          if attrs ? envoyGatewayBindAddresses && builtins.isAttrs attrs.envoyGatewayBindAddresses then
            {
              EnvoyGatewayBindAddresses = mapAttrs (
                _: ConsulGatewayBindAddress.toJSON
              ) attrs.envoyGatewayBindAddresses;
            }
          else
            { }
        )
        // (
          if attrs ? envoyGatewayBindTaggedAddresses && attrs.envoyGatewayBindTaggedAddresses != null then
            { EnvoyGatewayBindTaggedAddresses = attrs.envoyGatewayBindTaggedAddresses; }
          else
            { }
        )
        // (
          if attrs ? envoyGatewayNoDefaultBind && attrs.envoyGatewayNoDefaultBind != null then
            { EnvoyGatewayNoDefaultBind = attrs.envoyGatewayNoDefaultBind; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulGatewayProxy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? EnvoyGatewayBindAddresses && builtins.isList attrs.EnvoyGatewayBindAddresses then
          {
            envoyGatewayBindAddresses = builtins.listToAttrs (
              builtins.map (
                v: nameValuePair v.Name (ConsulGatewayBindAddress.fromJSON v)
              ) attrs.EnvoyGatewayBindAddresses
            );
          }
        else
  ...
  _module.transformers.ConsulGatewayTlsConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? cipherSuites && attrs.cipherSuites != null then
            { CipherSuites = attrs.cipherSuites; }
          else
            { }
        )
        // (if attrs ? enabled && attrs.enabled != null then { Enabled = attrs.enabled; } else { })
        // (
          if attrs ? sds && attrs.sds != null then
            { SDS = ConsulGatewayTlssdsConfig.toJSON attrs.sds; }
          else
            { }
        )
        // (
          if attrs ? tlsMaxVersion && attrs.tlsMaxVersion != null then
            { TLSMaxVersion = attrs.tlsMaxVersion; }
          else
            { }
        )
        // (
          if attrs ? tlsMinVersion && attrs.tlsMinVersion != null then
            { TLSMinVersion = attrs.tlsMinVersion; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulGatewayTlsConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? SDS && attrs.SDS != null then
          { sds = ConsulGatewayTlssdsConfig.fromJSON attrs.SDS; }
        else
          { }
      )
      // (
  ...
  _module.transformers.ConsulGatewayTlssdsConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? certResource && attrs.certResource != null then
            { CertResource = attrs.certResource; }
          else
            { }
        )
        // (
          if attrs ? clusterName && attrs.clusterName != null then
  ...
  _module.transformers.ConsulGatewayTlssdsConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulHttpHeaderModifiers.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.ConsulHttpHeaderModifiers.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulIngressConfigEntry.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? listeners && builtins.isList attrs.listeners then
            { Listeners = builtins.map ConsulIngressListener.toJSON attrs.listeners; }
          else
            { }
        )
        // (
  ...
  _module.transformers.ConsulIngressConfigEntry.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Listeners && builtins.isList attrs.Listeners then
          { listeners = builtins.map ConsulIngressListener.fromJSON attrs.Listeners; }
        else
          { }
      )
      // (
        if attrs ? TLS && attrs.TLS != null then
          { tls = ConsulGatewayTlsConfig.fromJSON attrs.TLS; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulIngressListener.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? protocol && attrs.protocol != null then { Protocol = attrs.protocol; } else { })
        // (
          if attrs ? services && builtins.isList attrs.services then
            { Services = builtins.map ConsulIngressService.toJSON attrs.services; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulIngressListener.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Services && builtins.isList attrs.Services then
          { services = builtins.map ConsulIngressService.fromJSON attrs.Services; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulIngressService.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? maxConcurrentRequests && attrs.maxConcurrentRequests != null then
            { MaxConcurrentRequests = attrs.maxConcurrentRequests; }
          else
            { }
        )
        // (
          if attrs ? maxConnections && attrs.maxConnections != null then
            { MaxConnections = attrs.maxConnections; }
          else
            { }
        )
        // (
          if attrs ? maxPendingRequests && attrs.maxPendingRequests != null then
            { MaxPendingRequests = attrs.maxPendingRequests; }
          else
            { }
        )
        // (if attrs ? name && attrs.name != null then { Name = attrs.name; } else { })
        // (
          if attrs ? requestHeaders && attrs.requestHeaders != null then
            { RequestHeaders = ConsulHttpHeaderModifiers.toJSON attrs.requestHeaders; }
          else
            { }
        )
        // (
          if attrs ? responseHeaders && attrs.responseHeaders != null then
            { ResponseHeaders = ConsulHttpHeaderModifiers.toJSON attrs.responseHeaders; }
          else
            { }
        )
        // (
  ...
  _module.transformers.ConsulIngressService.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? RequestHeaders && attrs.RequestHeaders != null then
          { requestHeaders = ConsulHttpHeaderModifiers.fromJSON attrs.RequestHeaders; }
        else
          { }
      )
      // (
        if attrs ? ResponseHeaders && attrs.ResponseHeaders != null then
          { responseHeaders = ConsulHttpHeaderModifiers.fromJSON attrs.ResponseHeaders; }
        else
          { }
      )
      // (
  ...
  _module.transformers.ConsulLinkedService.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.ConsulLinkedService.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulMeshConfigEntry.toJSON =
    with lib;
    with config._module.transformers;
    attrs: if !(builtins.isAttrs attrs) then null else ({ });

  # Convert a ConsulMeshConfigEntry JSON object into a Nix module.
  _module.transformers.ConsulMeshConfigEntry.fromJSON =
    with lib;
    with config._module.transformers;
    attrs: ({ });

  # Convert a ConsulMeshGateway Nix module into a JSON object.
  _module.transformers.ConsulMeshGateway.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.ConsulMeshGateway.fromJSON =
    with lib;
    with config._module.transformers;
    attrs: ({ } // (if attrs ? Mode && attrs.Mode != null then { mode = attrs.Mode; } else { }));

  # Convert a ConsulProxy Nix module into a JSON object.
  _module.transformers.ConsulProxy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? config && attrs.config != null then { Config = attrs.config; } else { })
        // (
          if attrs ? expose && attrs.expose != null then
            { Expose = ConsulExposeConfig.toJSON attrs.expose; }
          else
            { }
        )
        // (
          if attrs ? localServiceAddress && attrs.localServiceAddress != null then
            { LocalServiceAddress = attrs.localServiceAddress; }
          else
            { }
        )
        // (
          if attrs ? localServicePort && attrs.localServicePort != null then
            { LocalServicePort = attrs.localServicePort; }
          else
            { }
        )
        // (
          if attrs ? transparentProxy && attrs.transparentProxy != null then
            { TransparentProxy = ConsulTransparentProxy.toJSON attrs.transparentProxy; }
          else
            { }
        )
        // (
          if attrs ? upstreams && builtins.isList attrs.upstreams then
            { Upstreams = builtins.map ConsulUpstream.toJSON attrs.upstreams; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulProxy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Expose && attrs.Expose != null then
          { expose = ConsulExposeConfig.fromJSON attrs.Expose; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? TransparentProxy && attrs.TransparentProxy != null then
          { transparentProxy = ConsulTransparentProxy.fromJSON attrs.TransparentProxy; }
        else
          { }
      )
      // (
        if attrs ? Upstreams && builtins.isList attrs.Upstreams then
          { upstreams = builtins.map ConsulUpstream.fromJSON attrs.Upstreams; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulSidecarService.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? disableDefaultTcpCheck && attrs.disableDefaultTcpCheck != null then
            { DisableDefaultTCPCheck = attrs.disableDefaultTcpCheck; }
          else
            { }
        )
  ...
  _module.transformers.ConsulSidecarService.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulTerminatingConfigEntry.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? services && builtins.isList attrs.services then
            { Services = builtins.map ConsulLinkedService.toJSON attrs.services; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulTerminatingConfigEntry.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Services && builtins.isList attrs.Services then
          { services = builtins.map ConsulLinkedService.fromJSON attrs.Services; }
        else
          { }
      )
    );
  ...
  _module.transformers.ConsulTransparentProxy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? excludeInboundPorts && attrs.excludeInboundPorts != null then
            { ExcludeInboundPorts = attrs.excludeInboundPorts; }
          else
            { }
        )
        // (
          if attrs ? excludeOutboundCidrs && attrs.excludeOutboundCidrs != null then
            { ExcludeOutboundCIDRs = attrs.excludeOutboundCidrs; }
          else
            { }
        )
        // (
          if attrs ? excludeOutboundPorts && attrs.excludeOutboundPorts != null then
            { ExcludeOutboundPorts = attrs.excludeOutboundPorts; }
          else
            { }
        )
        // (
          if attrs ? excludeUids && attrs.excludeUids != null then
            { ExcludeUIDs = attrs.excludeUids; }
          else
            { }
        )
        // (if attrs ? noDns && attrs.noDns != null then { NoDNS = attrs.noDns; } else { })
        // (
          if attrs ? outboundPort && attrs.outboundPort != null then
            { OutboundPort = attrs.outboundPort; }
          else
            { }
        )
  ...
  _module.transformers.ConsulTransparentProxy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ConsulUpstream.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? destinationName && attrs.destinationName != null then
            { DestinationName = attrs.destinationName; }
          else
            { }
        )
        // (
          if attrs ? destinationNamespace && attrs.destinationNamespace != null then
            { DestinationNamespace = attrs.destinationNamespace; }
          else
            { }
        )
        // (
          if attrs ? destinationPartition && attrs.destinationPartition != null then
            { DestinationPartition = attrs.destinationPartition; }
          else
            { }
        )
        // (
          if attrs ? destinationPeer && attrs.destinationPeer != null then
            { DestinationPeer = attrs.destinationPeer; }
          else
            { }
        )
        // (
          if attrs ? destinationType && attrs.destinationType != null then
            { DestinationType = attrs.destinationType; }
          else
            { }
        )
        // (
          if attrs ? localBindAddress && attrs.localBindAddress != null then
            { LocalBindAddress = attrs.localBindAddress; }
          else
            { }
        )
        // (
          if attrs ? localBindPort && attrs.localBindPort != null then
            { LocalBindPort = attrs.localBindPort; }
          else
            { }
        )
        // (
          if attrs ? localBindSocketMode && attrs.localBindSocketMode != null then
            { LocalBindSocketMode = attrs.localBindSocketMode; }
          else
            { }
        )
        // (
          if attrs ? localBindSocketPath && attrs.localBindSocketPath != null then
            { LocalBindSocketPath = attrs.localBindSocketPath; }
          else
            { }
        )
        // (
          if attrs ? meshGateway && attrs.meshGateway != null then
            { MeshGateway = ConsulMeshGateway.toJSON attrs.meshGateway; }
          else
            { }
        )
      );
  ...
  _module.transformers.ConsulUpstream.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? MeshGateway && attrs.MeshGateway != null then
          { meshGateway = ConsulMeshGateway.fromJSON attrs.MeshGateway; }
        else
          { }
      )
    );
  ...
  _module.transformers.DnsConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.DnsConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.DisconnectStrategy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? stopOnClientAfter && attrs.stopOnClientAfter != null then
            { StopOnClientAfter = attrs.stopOnClientAfter; }
          else
            { }
        )
      );
  ...
  _module.transformers.DisconnectStrategy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.DispatchPayloadConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.DispatchPayloadConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs: ({ } // (if attrs ? File && attrs.File != null then { file = attrs.File; } else { }));

  # Convert a EphemeralDisk Nix module into a JSON object.
  _module.transformers.EphemeralDisk.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.EphemeralDisk.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Job.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? affinities && builtins.isList attrs.affinities then
            { Affinities = builtins.map Affinity.toJSON attrs.affinities; }
          else
            { }
        )
        // (if attrs ? allAtOnce && attrs.allAtOnce != null then { AllAtOnce = attrs.allAtOnce; } else { })
        // (
          if attrs ? constraints && builtins.isList attrs.constraints then
            { Constraints = builtins.map Constraint.toJSON attrs.constraints; }
          else
            { }
        )
        // (
          if attrs ? consulToken && attrs.consulToken != null then
            { ConsulToken = attrs.consulToken; }
          else
            { }
        )
        // (
          if attrs ? datacenters && attrs.datacenters != null then
            { Datacenters = attrs.datacenters; }
          else
            { }
        )
        // (
          if attrs ? group && builtins.isAttrs attrs.group then
            { TaskGroups = mapAttrsToList (_: TaskGroup.toJSON) attrs.group; }
          else
            { }
        )
        ...
        // (if attrs ? meta && attrs.meta != null then { Meta = attrs.meta; } else { })
        // (
          if attrs ? migrate && attrs.migrate != null then
            { Migrate = MigrateStrategy.toJSON attrs.migrate; }
          else
            { }
        )
        // (
          if attrs ? multiregion && attrs.multiregion != null then
            { Multiregion = Multiregion.toJSON attrs.multiregion; }
          else
            { }
        )
        // (if attrs ? name && attrs.name != null then { Name = attrs.name; } else { })
        ...
        // (
          if attrs ? parameterized && attrs.parameterized != null then
            { ParameterizedJob = ParameterizedJobConfig.toJSON attrs.parameterized; }
          else
            { }
        )
        // (
          if attrs ? periodic && attrs.periodic != null then
            { Periodic = PeriodicConfig.toJSON attrs.periodic; }
          else
            { }
        )
        ...
        // (
          if attrs ? reschedule && attrs.reschedule != null then
            { Reschedule = ReschedulePolicy.toJSON attrs.reschedule; }
          else
            { }
        )
        // (
          if attrs ? spreads && builtins.isList attrs.spreads then
            { Spreads = builtins.map Spread.toJSON attrs.spreads; }
          else
            { }
        )
        ...
        // (
          if attrs ? update && attrs.update != null then
            { Update = UpdateStrategy.toJSON attrs.update; }
          else
            { }
        )
        // (
  ...
  _module.transformers.Job.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Affinities && builtins.isList attrs.Affinities then
          { affinities = builtins.map Affinity.fromJSON attrs.Affinities; }
        else
          { }
      )
      // (if attrs ? AllAtOnce && attrs.AllAtOnce != null then { allAtOnce = attrs.AllAtOnce; } else { })
      // (
        if attrs ? Constraints && builtins.isList attrs.Constraints then
          { constraints = builtins.map Constraint.fromJSON attrs.Constraints; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? TaskGroups && builtins.isList attrs.TaskGroups then
          {
            group = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Name (TaskGroup.fromJSON v)) attrs.TaskGroups
            );
          }
        else
          { }
      ...
      // (
        if attrs ? Migrate && attrs.Migrate != null then
          { migrate = MigrateStrategy.fromJSON attrs.Migrate; }
        else
          { }
      )
      // (
        if attrs ? Multiregion && attrs.Multiregion != null then
          { multiregion = Multiregion.fromJSON attrs.Multiregion; }
        else
          { }
      )
      // (if attrs ? Name && attrs.Name != null then { name = attrs.Name; } else { })
      ...
      // (if attrs ? NodePool && attrs.NodePool != null then { nodePool = attrs.NodePool; } else { })
      // (
        if attrs ? ParameterizedJob && attrs.ParameterizedJob != null then
          { parameterized = ParameterizedJobConfig.fromJSON attrs.ParameterizedJob; }
        else
          { }
      )
      // (
        if attrs ? Periodic && attrs.Periodic != null then
          { periodic = PeriodicConfig.fromJSON attrs.Periodic; }
        else
          { }
      )
      // (if attrs ? Priority && attrs.Priority != null then { priority = attrs.Priority; } else { })
      ...
      // (
        if attrs ? Reschedule && attrs.Reschedule != null then
          { reschedule = ReschedulePolicy.fromJSON attrs.Reschedule; }
        else
          { }
      )
      // (
        if attrs ? Spreads && builtins.isList attrs.Spreads then
          { spreads = builtins.map Spread.fromJSON attrs.Spreads; }
        else
          { }
      )
      // (if attrs ? Type && attrs.Type != null then { type = attrs.Type; } else { })
      ...
      // (
        if attrs ? Update && attrs.Update != null then
          { update = UpdateStrategy.fromJSON attrs.Update; }
        else
          { }
      )
      // (
  ...
  _module.transformers.JobUiConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? description && attrs.description != null then
            { Description = attrs.description; }
          else
            { }
        )
        // (
          if attrs ? links && builtins.isList attrs.links then
            { Links = builtins.map JobUiLink.toJSON attrs.links; }
          else
            { }
        )
      );
  ...
  _module.transformers.JobUiConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Links && builtins.isList attrs.Links then
          { links = builtins.map JobUiLink.fromJSON attrs.Links; }
        else
          { }
      )
    );
  ...
  _module.transformers.JobUiLink.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.JobUiLink.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.LogConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? enabled && attrs.enabled != null then { Enabled = attrs.enabled; } else { })
        // (
          if attrs ? maxFileSize && attrs.maxFileSize != null then
            { MaxFileSizeMB = attrs.maxFileSize; }
          else
            { }
        )
  ...
  _module.transformers.LogConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (if attrs ? Enabled && attrs.Enabled != null then { enabled = attrs.Enabled; } else { })
      // (
        if attrs ? MaxFileSizeMB && attrs.MaxFileSizeMB != null then
          { maxFileSize = attrs.MaxFileSizeMB; }
        else
          { }
      )
      // (if attrs ? MaxFiles && attrs.MaxFiles != null then { maxFiles = attrs.MaxFiles; } else { })
  ...
  _module.transformers.MigrateStrategy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? healthCheck && attrs.healthCheck != null then
            { HealthCheck = attrs.healthCheck; }
          else
            { }
        )
        // (
          if attrs ? healthyDeadline && attrs.healthyDeadline != null then
            { HealthyDeadline = attrs.healthyDeadline; }
          else
            { }
        )
        // (
          if attrs ? maxParallel && attrs.maxParallel != null then
            { MaxParallel = attrs.maxParallel; }
          else
            { }
        )
        // (
          if attrs ? minHealthyTime && attrs.minHealthyTime != null then
            { MinHealthyTime = attrs.minHealthyTime; }
          else
            { }
        )
      );
  ...
  _module.transformers.MigrateStrategy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Multiregion.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? region && builtins.isAttrs attrs.region then
            { Regions = mapAttrsToList (_: MultiregionRegion.toJSON) attrs.region; }
          else
            { }
        )
        // (
          if attrs ? strategy && attrs.strategy != null then
            { Strategy = MultiregionStrategy.toJSON attrs.strategy; }
          else
            { }
        )
      );
  ...
  _module.transformers.Multiregion.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      { }
      // (
        if attrs ? Regions && builtins.isList attrs.Regions then
          {
            region = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Name (MultiregionRegion.fromJSON v)) attrs.Regions
            );
          }
        else
          { }
      ...
      // (
        if attrs ? Strategy && attrs.Strategy != null then
          { strategy = MultiregionStrategy.fromJSON attrs.Strategy; }
        else
          { }
      )
    );
  ...
  _module.transformers.MultiregionRegion.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.MultiregionRegion.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.MultiregionStrategy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.MultiregionStrategy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.NumaResource.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.NumaResource.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.NetworkResource.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? mode && attrs.mode != null then { Mode = attrs.mode; } else { })
        // (
          if attrs ? port && builtins.isAttrs attrs.port then
            { DynamicPorts = mapAttrsToList (_: Port.toJSON) attrs.port; }
          else
            { }
        )
        // (
          if attrs ? reservedPorts && builtins.isAttrs attrs.reservedPorts then
            { ReservedPorts = mapAttrsToList (_: Port.toJSON) attrs.reservedPorts; }
          else
            { }
        )
      );
  ...
  _module.transformers.NetworkResource.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (if attrs ? Mode && attrs.Mode != null then { mode = attrs.Mode; } else { })
      // (
        if attrs ? DynamicPorts && builtins.isList attrs.DynamicPorts then
          {
            port = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Label (Port.fromJSON v)) attrs.DynamicPorts
            );
          }
        else
          { }
      ...
      // (
        if attrs ? ReservedPorts && builtins.isList attrs.ReservedPorts then
          {
            reservedPorts = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Label (Port.fromJSON v)) attrs.ReservedPorts
            );
          }
        else
          { }
  ...
  _module.transformers.ParameterizedJobConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? metaOptional && attrs.metaOptional != null then
            { MetaOptional = attrs.metaOptional; }
          else
            { }
        )
        // (
          if attrs ? metaRequired && attrs.metaRequired != null then
            { MetaRequired = attrs.metaRequired; }
          else
            { }
        )
  ...
  _module.transformers.ParameterizedJobConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.PeriodicConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? enabled && attrs.enabled != null then { Enabled = attrs.enabled; } else { })
        // (
          if attrs ? prohibitOverlap && attrs.prohibitOverlap != null then
            { ProhibitOverlap = attrs.prohibitOverlap; }
          else
            { }
        )
  ...
  _module.transformers.PeriodicConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Port.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? hostNetwork && attrs.hostNetwork != null then
            { HostNetwork = attrs.hostNetwork; }
          else
            { }
        )
        // (
          if attrs ? ignoreCollision && attrs.ignoreCollision != null then
            { IgnoreCollision = attrs.ignoreCollision; }
          else
            { }
        )
        // (if attrs ? label && attrs.label != null then { Label = attrs.label; } else { })
  ...
  _module.transformers.Port.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.RequestedDevice.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.RequestedDevice.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ReschedulePolicy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? delayFunction && attrs.delayFunction != null then
            { DelayFunction = attrs.delayFunction; }
          else
            { }
        )
  ...
  _module.transformers.ReschedulePolicy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Resources.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? device && builtins.isAttrs attrs.device then
            { Devices = mapAttrsToList (_: RequestedDevice.toJSON) attrs.device; }
          else
            { }
        )
        ...
        // (
          if attrs ? networks && builtins.isList attrs.networks then
            { Networks = builtins.map NetworkResource.toJSON attrs.networks; }
          else
            { }
        )
  ...
  _module.transformers.Resources.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (if attrs ? CPU && attrs.CPU != null then { cpu = attrs.CPU; } else { })
      // (
        if attrs ? Devices && builtins.isList attrs.Devices then
          {
            device = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Name (RequestedDevice.fromJSON v)) attrs.Devices
            );
          }
        else
          { }
      ...
      // (
        if attrs ? Networks && builtins.isList attrs.Networks then
          { networks = builtins.map NetworkResource.fromJSON attrs.Networks; }
        else
          { }
      )
      // (
  ...
  _module.transformers.RestartPolicy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? mode && attrs.mode != null then { Mode = attrs.mode; } else { })
        // (
          if attrs ? renderTemplates && attrs.renderTemplates != null then
            { RenderTemplates = attrs.renderTemplates; }
          else
            { }
        )
      );
  ...
  _module.transformers.RestartPolicy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ScalingPolicy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.ScalingPolicy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Service.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? address && attrs.address != null then { Address = attrs.address; } else { })
        // (
          if attrs ? addressMode && attrs.addressMode != null then
            { AddressMode = attrs.addressMode; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? checkRestart && attrs.checkRestart != null then
            { CheckRestart = CheckRestart.toJSON attrs.checkRestart; }
          else
            { }
        )
        // (
          if attrs ? checks && builtins.isList attrs.checks then
            { Checks = builtins.map ServiceCheck.toJSON attrs.checks; }
          else
            { }
        )
        // (if attrs ? cluster && attrs.cluster != null then { Cluster = attrs.cluster; } else { })
        // (
          if attrs ? connect && attrs.connect != null then
            { Connect = ConsulConnect.toJSON attrs.connect; }
          else
            { }
        )
        // (
          if attrs ? enableTagOverride && attrs.enableTagOverride != null then
            { EnableTagOverride = attrs.enableTagOverride; }
          else
            { }
        )
        // (
          if attrs ? identity && attrs.identity != null then
            { Identity = WorkloadIdentity.toJSON attrs.identity; }
          else
            { }
        )
        // (if attrs ? meta && attrs.meta != null then { Meta = attrs.meta; } else { })
        ...
        // (
          if attrs ? taggedAddresses && attrs.taggedAddresses != null then
            { TaggedAddresses = attrs.taggedAddresses; }
          else
            { }
        )
        // (if attrs ? tags && attrs.tags != null then { Tags = attrs.tags; } else { })
        ...
        // (
          if attrs ? weights && attrs.weights != null then
            { Weights = ServiceWeights.toJSON attrs.weights; }
          else
            { }
        )
      );
  ...
  _module.transformers.Service.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? CheckRestart && attrs.CheckRestart != null then
          { checkRestart = CheckRestart.fromJSON attrs.CheckRestart; }
        else
          { }
      )
      // (
        if attrs ? Checks && builtins.isList attrs.Checks then
          { checks = builtins.map ServiceCheck.fromJSON attrs.Checks; }
        else
          { }
      )
      // (if attrs ? Cluster && attrs.Cluster != null then { cluster = attrs.Cluster; } else { })
      // (
        if attrs ? Connect && attrs.Connect != null then
          { connect = ConsulConnect.fromJSON attrs.Connect; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? Identity && attrs.Identity != null then
          { identity = WorkloadIdentity.fromJSON attrs.Identity; }
        else
          { }
      )
      // (if attrs ? Meta && attrs.Meta != null then { meta = attrs.Meta; } else { })
      ...
      // (
        if attrs ? Weights && attrs.Weights != null then
          { weights = ServiceWeights.fromJSON attrs.Weights; }
        else
          { }
      )
    );
  ...
  _module.transformers.ServiceCheck.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? failuresBeforeCritical && attrs.failuresBeforeCritical != null then
            { FailuresBeforeCritical = attrs.failuresBeforeCritical; }
          else
            { }
        )
        // (
          if attrs ? failuresBeforeWarning && attrs.failuresBeforeWarning != null then
            { FailuresBeforeWarning = attrs.failuresBeforeWarning; }
          else
            { }
        )
        // (
          if attrs ? grpcService && attrs.grpcService != null then
            { GRPCService = attrs.grpcService; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? initialStatus && attrs.initialStatus != null then
            { InitialStatus = attrs.initialStatus; }
          else
            { }
        )
        // (if attrs ? interval && attrs.interval != null then { Interval = attrs.interval; } else { })
        ...
        // (if attrs ? protocol && attrs.protocol != null then { Protocol = attrs.protocol; } else { })
        // (
          if attrs ? successBeforePassing && attrs.successBeforePassing != null then
            { SuccessBeforePassing = attrs.successBeforePassing; }
          else
            { }
        )
        // (if attrs ? task && attrs.task != null then { TaskName = attrs.task; } else { })
        // (if attrs ? timeout && attrs.timeout != null then { Timeout = attrs.timeout; } else { })
        // (
          if attrs ? tlsServerName && attrs.tlsServerName != null then
            { TLSServerName = attrs.tlsServerName; }
          else
            { }
        )
        // (
          if attrs ? tlsSkipVerify && attrs.tlsSkipVerify != null then
            { TLSSkipVerify = attrs.tlsSkipVerify; }
          else
            { }
        )
        // (if attrs ? type && attrs.type != null then { Type = attrs.type; } else { })
  ...
  _module.transformers.ServiceCheck.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.ServiceWeights.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.ServiceWeights.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.SidecarTask.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? killTimeout && attrs.killTimeout != null then
        ...
        // (if attrs ? name && attrs.name != null then { Name = attrs.name; } else { })
        // (
          if attrs ? resources && attrs.resources != null then
            { Resources = Resources.toJSON attrs.resources; }
          else
            { }
        )
        // (
          if attrs ? shutdownDelay && attrs.shutdownDelay != null then
            { ShutdownDelay = attrs.shutdownDelay; }
          else
            { }
        )
        // (if attrs ? user && attrs.user != null then { User = attrs.user; } else { })
        // (
          if attrs ? volumeMounts && builtins.isList attrs.volumeMounts then
            { VolumeMounts = builtins.map VolumeMount.toJSON attrs.volumeMounts; }
          else
            { }
        )
      );
  ...
  _module.transformers.SidecarTask.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? LogConfig && attrs.LogConfig != null then
          { logs = LogConfig.fromJSON attrs.LogConfig; }
        else
          { }
      )
      // (if attrs ? Meta && attrs.Meta != null then { meta = attrs.Meta; } else { })
      ...
      // (
        if attrs ? Resources && attrs.Resources != null then
          { resources = Resources.fromJSON attrs.Resources; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? VolumeMounts && builtins.isList attrs.VolumeMounts then
          { volumeMounts = builtins.map VolumeMount.fromJSON attrs.VolumeMounts; }
        else
          { }
      )
    );
  ...
  _module.transformers.Spread.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? target && builtins.isAttrs attrs.target then
            { SpreadTarget = mapAttrsToList (_: SpreadTarget.toJSON) attrs.target; }
          else
            { }
        )
        // (if attrs ? weight && attrs.weight != null then { Weight = attrs.weight; } else { })
  ...
  _module.transformers.Spread.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (if attrs ? Attribute && attrs.Attribute != null then { attribute = attrs.Attribute; } else { })
      // (
        if attrs ? SpreadTarget && builtins.isList attrs.SpreadTarget then
          {
            target = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Value (SpreadTarget.fromJSON v)) attrs.SpreadTarget
            );
          }
        else
          { }
  ...
  _module.transformers.SpreadTarget.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.SpreadTarget.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Task.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? action && builtins.isAttrs attrs.action then
            { Actions = mapAttrsToList (_: Action.toJSON) attrs.action; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? artifacts && builtins.isList attrs.artifacts then
            { Artifacts = builtins.map TaskArtifact.toJSON attrs.artifacts; }
          else
            { }
        )
        // (if attrs ? config && attrs.config != null then { Config = attrs.config; } else { })
        ...
        // (
          if attrs ? csiPlugin && attrs.csiPlugin != null then
            { CSIPluginConfig = TaskCsiPluginConfig.toJSON attrs.csiPlugin; }
          else
            { }
        )
        // (
          if attrs ? dispatchPayload && attrs.dispatchPayload != null then
            { DispatchPayload = DispatchPayloadConfig.toJSON attrs.dispatchPayload; }
          else
            { }
        )
        // (if attrs ? driver && attrs.driver != null then { Driver = attrs.driver; } else { })
        // (if attrs ? env && attrs.env != null then { Env = attrs.env; } else { })
        // (
          if attrs ? identities && builtins.isList attrs.identities then
            { Identities = builtins.map WorkloadIdentity.toJSON attrs.identities; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? lifecycle && attrs.lifecycle != null then
            { Lifecycle = TaskLifecycle.toJSON attrs.lifecycle; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? restart && attrs.restart != null then
            { RestartPolicy = RestartPolicy.toJSON attrs.restart; }
          else
            { }
        )
        // (
          if attrs ? scalings && builtins.isList attrs.scalings then
            { ScalingPolicies = builtins.map ScalingPolicy.toJSON attrs.scalings; }
          else
            { }
        )
        // (
          if attrs ? schedule && attrs.schedule != null then
            { Schedule = TaskSchedule.toJSON attrs.schedule; }
          else
            { }
        )
        // (
          if attrs ? services && builtins.isList attrs.services then
            { Services = builtins.map Service.toJSON attrs.services; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? templates && builtins.isList attrs.templates then
            { Templates = builtins.map Template.toJSON attrs.templates; }
          else
            { }
        )
        // (if attrs ? user && attrs.user != null then { User = attrs.user; } else { })
  ...
  _module.transformers.Task.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      { }
      // (
        if attrs ? Actions && builtins.isList attrs.Actions then
          {
            action = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Name (Action.fromJSON v)) attrs.Actions
            );
          }
        else
          { }
      ...
      // (
        if attrs ? Artifacts && builtins.isList attrs.Artifacts then
          { artifacts = builtins.map TaskArtifact.fromJSON attrs.Artifacts; }
        else
          { }
      )
      // (if attrs ? Config && attrs.Config != null then { config = attrs.Config; } else { })
      ...
      // (
        if attrs ? CSIPluginConfig && attrs.CSIPluginConfig != null then
          { csiPlugin = TaskCsiPluginConfig.fromJSON attrs.CSIPluginConfig; }
        else
          { }
      )
      // (
        if attrs ? DispatchPayload && attrs.DispatchPayload != null then
          { dispatchPayload = DispatchPayloadConfig.fromJSON attrs.DispatchPayload; }
        else
          { }
      )
      // (if attrs ? Driver && attrs.Driver != null then { driver = attrs.Driver; } else { })
      ...
      // (
        if attrs ? Identities && builtins.isList attrs.Identities then
          { identities = builtins.map WorkloadIdentity.fromJSON attrs.Identities; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? Lifecycle && attrs.Lifecycle != null then
          { lifecycle = TaskLifecycle.fromJSON attrs.Lifecycle; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? RestartPolicy && attrs.RestartPolicy != null then
          { restart = RestartPolicy.fromJSON attrs.RestartPolicy; }
        else
          { }
      )
      // (
        if attrs ? ScalingPolicies && builtins.isList attrs.ScalingPolicies then
          { scalings = builtins.map ScalingPolicy.fromJSON attrs.ScalingPolicies; }
        else
          { }
      )
      // (
        if attrs ? Schedule && attrs.Schedule != null then
          { schedule = TaskSchedule.fromJSON attrs.Schedule; }
        else
          { }
      )
      // (
        if attrs ? Services && builtins.isList attrs.Services then
          { services = builtins.map Service.fromJSON attrs.Services; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? Templates && builtins.isList attrs.Templates then
          { templates = builtins.map Template.fromJSON attrs.Templates; }
        else
          { }
      )
      // (if attrs ? User && attrs.User != null then { user = attrs.User; } else { })
  ...
  _module.transformers.TaskArtifact.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? destination && attrs.destination != null then
            { RelativeDest = attrs.destination; }
          else
            { }
        )
  ...
  _module.transformers.TaskArtifact.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (if attrs ? Chown && attrs.Chown != null then { chown = attrs.Chown; } else { })
      // (
        if attrs ? RelativeDest && attrs.RelativeDest != null then
          { destination = attrs.RelativeDest; }
        else
          { }
      )
      // (
        if attrs ? GetterHeaders && attrs.GetterHeaders != null then
          { headers = attrs.GetterHeaders; }
        else
          { }
      )
      // (
        if attrs ? GetterInsecure && attrs.GetterInsecure != null then
          { insecure = attrs.GetterInsecure; }
        else
          { }
      )
      // (if attrs ? GetterMode && attrs.GetterMode != null then { mode = attrs.GetterMode; } else { })
      // (
        if attrs ? GetterOptions && attrs.GetterOptions != null then
          { options = attrs.GetterOptions; }
        else
          { }
      )
      // (
  ...
  _module.transformers.TaskCsiPluginConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? healthTimeout && attrs.healthTimeout != null then
            { HealthTimeout = attrs.healthTimeout; }
          else
            { }
        )
        // (if attrs ? id && attrs.id != null then { ID = attrs.id; } else { })
        ...
        // (
          if attrs ? stagePublishBaseDir && attrs.stagePublishBaseDir != null then
            { StagePublishBaseDir = attrs.stagePublishBaseDir; }
          else
            { }
        )
        // (if attrs ? type && attrs.type != null then { Type = attrs.type; } else { })
  ...
  _module.transformers.TaskCsiPluginConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.TaskGroup.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? count && attrs.count != null then { Count = attrs.count; } else { })
        // (
          if attrs ? disconnect && attrs.disconnect != null then
            { Disconnect = DisconnectStrategy.toJSON attrs.disconnect; }
          else
            { }
        )
        // (
          if attrs ? ephemeralDisk && attrs.ephemeralDisk != null then
            { EphemeralDisk = EphemeralDisk.toJSON attrs.ephemeralDisk; }
          else
            { }
        )
        // (
          if attrs ? maxClientDisconnect && attrs.maxClientDisconnect != null then
            { MaxClientDisconnect = attrs.maxClientDisconnect; }
          else
            { }
        )
        // (if attrs ? meta && attrs.meta != null then { Meta = attrs.meta; } else { })
        ...
        // (
          if attrs ? preventRescheduleOnLost && attrs.preventRescheduleOnLost != null then
            { PreventRescheduleOnLost = attrs.preventRescheduleOnLost; }
          else
            { }
        )
        // (
          if attrs ? reschedule && attrs.reschedule != null then
            { ReschedulePolicy = ReschedulePolicy.toJSON attrs.reschedule; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? scaling && attrs.scaling != null then
            { Scaling = ScalingPolicy.toJSON attrs.scaling; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? stopAfterClientDisconnect && attrs.stopAfterClientDisconnect != null then
            { StopAfterClientDisconnect = attrs.stopAfterClientDisconnect; }
          else
            { }
        )
        // (
          if attrs ? task && builtins.isAttrs attrs.task then
            { Tasks = mapAttrsToList (_: Task.toJSON) attrs.task; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? volume && builtins.isAttrs attrs.volume then
            { Volumes = mapAttrs (_: VolumeRequest.toJSON) attrs.volume; }
          else
            { }
        )
      );
  ...
  _module.transformers.TaskGroup.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? Disconnect && attrs.Disconnect != null then
          { disconnect = DisconnectStrategy.fromJSON attrs.Disconnect; }
        else
          { }
      )
      // (
        if attrs ? EphemeralDisk && attrs.EphemeralDisk != null then
          { ephemeralDisk = EphemeralDisk.fromJSON attrs.EphemeralDisk; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? ReschedulePolicy && attrs.ReschedulePolicy != null then
          { reschedule = ReschedulePolicy.fromJSON attrs.ReschedulePolicy; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? Scaling && attrs.Scaling != null then
          { scaling = ScalingPolicy.fromJSON attrs.Scaling; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? Tasks && builtins.isList attrs.Tasks then
          {
            task = builtins.listToAttrs (builtins.map (v: nameValuePair v.Name (Task.fromJSON v)) attrs.Tasks);
          }
        else
          { }
      )
      ...
      // (
        if attrs ? Volumes && builtins.isList attrs.Volumes then
          {
            volume = builtins.listToAttrs (
              builtins.map (v: nameValuePair v.Name (VolumeRequest.fromJSON v)) attrs.Volumes
            );
          }
        else
          { }
  ...
  _module.transformers.TaskLifecycle.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.TaskLifecycle.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.TaskSchedule.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.TaskSchedule.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.TaskScheduleCron.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.TaskScheduleCron.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Template.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? changeScript && attrs.changeScript != null then
            { ChangeScript = ChangeScript.toJSON attrs.changeScript; }
          else
            { }
        )
        // (
          if attrs ? changeSignal && attrs.changeSignal != null then
            { ChangeSignal = attrs.changeSignal; }
          else
            { }
        )
        ...
        // (
          if attrs ? errorOnMissingKey && attrs.errorOnMissingKey != null then
            { ErrMissingKey = attrs.errorOnMissingKey; }
          else
            { }
        )
        // (if attrs ? gid && attrs.gid != null then { Gid = attrs.gid; } else { })
        // (
          if attrs ? leftDelimiter && attrs.leftDelimiter != null then
            { LeftDelim = attrs.leftDelimiter; }
          else
            { }
        )
        // (if attrs ? perms && attrs.perms != null then { Perms = attrs.perms; } else { })
        // (
          if attrs ? rightDelimiter && attrs.rightDelimiter != null then
            { RightDelim = attrs.rightDelimiter; }
          else
            { }
        )
  ...
  _module.transformers.Template.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? ChangeScript && attrs.ChangeScript != null then
          { changeScript = ChangeScript.fromJSON attrs.ChangeScript; }
        else
          { }
      )
      // (
      ...
      // (
        if attrs ? ErrMissingKey && attrs.ErrMissingKey != null then
          { errorOnMissingKey = attrs.ErrMissingKey; }
        else
          { }
      )
      // (if attrs ? Gid && attrs.Gid != null then { gid = attrs.Gid; } else { })
      ...
      // (if attrs ? Perms && attrs.Perms != null then { perms = attrs.Perms; } else { })
      // (
        if attrs ? RightDelim && attrs.RightDelim != null then
          { rightDelimiter = attrs.RightDelim; }
        else
          { }
      )
  ...
  _module.transformers.UpdateStrategy.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? autoPromote && attrs.autoPromote != null then
            { AutoPromote = attrs.autoPromote; }
          else
            { }
        )
        // (
        ...
        // (
          if attrs ? progressDeadline && attrs.progressDeadline != null then
            { ProgressDeadline = attrs.progressDeadline; }
          else
            { }
        )
  ...
  _module.transformers.UpdateStrategy.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.Vault.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        { }
        // (
          if attrs ? allowTokenExpiration && attrs.allowTokenExpiration != null then
            { AllowTokenExpiration = attrs.allowTokenExpiration; }
          else
            { }
        )
        // (
        ...
        // (if attrs ? cluster && attrs.cluster != null then { Cluster = attrs.cluster; } else { })
        // (
          if attrs ? disableFile && attrs.disableFile != null then
            { DisableFile = attrs.disableFile; }
          else
            { }
        )
        // (if attrs ? env && attrs.env != null then { Env = attrs.env; } else { })
  ...
  _module.transformers.Vault.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.VolumeMount.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? propagationMode && attrs.propagationMode != null then
            { PropagationMode = attrs.propagationMode; }
          else
            { }
        )
        // (if attrs ? readOnly && attrs.readOnly != null then { ReadOnly = attrs.readOnly; } else { })
        // (
          if attrs ? selinuxLabel && attrs.selinuxLabel != null then
            { SELinuxLabel = attrs.selinuxLabel; }
          else
            { }
        )
  ...
  _module.transformers.VolumeMount.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.VolumeRequest.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (
          if attrs ? attachmentMode && attrs.attachmentMode != null then
            { AttachmentMode = attrs.attachmentMode; }
          else
            { }
        )
        // (
          if attrs ? mountOptions && attrs.mountOptions != null then
            { MountOptions = CsiMountOptions.toJSON attrs.mountOptions; }
          else
            { }
        )
        // (if attrs ? name && attrs.name != null then { Name = attrs.name; } else { })
  ...
  _module.transformers.VolumeRequest.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
      ...
      // (
        if attrs ? MountOptions && attrs.MountOptions != null then
          { mountOptions = CsiMountOptions.fromJSON attrs.MountOptions; }
        else
          { }
      )
      // (if attrs ? Name && attrs.Name != null then { name = attrs.Name; } else { })
  ...
  _module.transformers.WaitConfig.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
  ...
  _module.transformers.WaitConfig.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
  ...
  _module.transformers.WorkloadIdentity.toJSON =
    with lib;
    with config._module.transformers;
    attrs:
    if !(builtins.isAttrs attrs) then
      ...
      (
        ...
        // (if attrs ? name && attrs.name != null then { Name = attrs.name; } else { })
        // (
          if attrs ? serviceName && attrs.serviceName != null then
  ...
  _module.transformers.WorkloadIdentity.fromJSON =
    with lib;
    with config._module.transformers;
    attrs:
    (
